...
const EditUserForm = ({ onFinish }) => {
    ...
    const renderNewPasswordField = () => {
        ...
        return (
            <FormField title="New Password" name="password" placeholder="New Password" rules={rules} inputType="password" />
        );
    };
    ...
    const renderImageField = () => {
        ...
        return (
            <FormField title="Image" name="image" placeholder="Image URL" rules={rules} />
        );
    };
