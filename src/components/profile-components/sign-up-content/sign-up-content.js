...
const SignUpForm = ({onFinish}) => {
    const renderUsernameField = () => {
        ...
        return (
            <FormField title={"Username"} name="username" placeholder="Username" rules={rules}/>
        );
    };
    ...
    const renderEmailField = () => {
        ...
        return (
            <FormField title={"Email"} name="email" placeholder="Email address" rules={rules}/>
        );
    };
    ...
    const renderRepeatPasswordField = () => {
        ...
        return (
            <FormField title={"Repeat Password"} name="repeatPassword" placeholder="Repeat Password" rules={rules}
                       inputType="password"/>
        );
    };
    ...
    const renderAgreementCheckbox = () => {
        const validator = (_, value) =>
            value ? Promise.resolve() : Promise.reject('Please agree to the processing of your personal information')
    ...
    const renderCreateButton = () => (
            <div className={classes.btnBlock}>
                ...
                <div>
                    <Text className={classes.text}>Already have an account? <Link to="/sign-in">Sign In</Link>.</Text>
                </div>
            </div>
        )
    ;
